...
class PhishingScan(TimeStampedModel):
    ...
    risk_level = models.CharField(max_length=16, blank=True, choices=[("low", "Low"), ("medium", "Medium"), ("high", "High"), ("critical", "Critical")])
    signals = models.JSONField(default=list)
    explanation = models.TextField(blank=True)
    url = models.CharField(max_length=2000, blank=True)  # CharField: accept scheme-less phishing URLs
